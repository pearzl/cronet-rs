...
impl UrlResponseInfo {
    ...
    pub fn url_chain_add(&self, element: &CStr) {
        unsafe {
    ...
    pub fn received_byte_count(&self, received_byte_count: i64) {
        unsafe {
            Cronet_UrlResponseInfo_received_byte_count_set(self.ptr, received_byte_count);
        }
    }

    pub fn url_get(&self) -> &CStr {
        unsafe {
    ...
    pub fn url_chain_at(&self, index: u32) -> &CStr {
        unsafe {
    ...
    pub fn all_headers_list_size(&self) -> u32 {
        unsafe { Cronet_UrlResponseInfo_all_headers_list_size(self.ptr) }
    }

    pub fn all_headers_list_at(&self, index: u32) -> BorrowedHttpHeader {
        unsafe {
    ...
    pub fn proxy_server_get(&self) -> &CStr {
        unsafe {
